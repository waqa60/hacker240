...
def login():
	os.system('clear')
	print logo
	print "\033[1;91m[1]\033[1;47m\033[1;95mLogin With Facebook"
        time.sleep(0.05)
        print "\033[1;92m[2]\033[1;47m\033[1;95mLogin With Token"
        time.sleep(0.05)
        print "\033[1;93m[3]\033[1;47m\033[1;95mDownload Token App"
        time.sleep(0.05)
	pilih_login()
...
def login1():
	...
	try:
		...
		os.system('clear')
                time.sleep(0.05)
		print logo                
		print "\033[1;97m•-----------------\033[1;37mWAQAS\033[1;97m-----------------•"
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\033[1;47m\033[1;91mWAQAS TOOL Login Successful\033[1;0m'
				os.system('xdg-open https://chat.whatsapp.com/Bgi6jhqCBWkL5cvggcqIiG')
	        login()
        elif peak =="5":
...
def pilih_super():
	...
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;32;40m[✺] WAQAS\033[1;95m"+o),;sys.stdout.flush();time.sleep(1)
